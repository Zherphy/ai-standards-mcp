...
- **项目技能**：使用 `[TEST_SKILL_NAME]` 技能编写测试用例
...
| TDD 开发 | [TEST_SKILL_NAME] | + **superpowers:test-driven-development** |
